...
class CommentIQ_Plugin
{
    ...
    /**
     * Get the bestwebsite comment generator.
     *
     * @return CommentIQ_Generator_bestwebsiteCommentGenerator
     */
    private function get_bestwebsite_comment_generator()
    {
        return new CommentIQ_Generator_bestwebsiteCommentGenerator($this->plugin_path . 'assets/templates/bestwebsite-comment.php', $this->get_supported_post_types());
    }
    ...
    {
        return array(
            new CommentIQ_Shortcode_bestwebsiteCommentShortcode($this->get_bestwebsite_comment_generator(), $this->get_supported_post_types()),
        );
    }
    ...
    private function get_subscribers()
    {
        return array(
            ...
            new CommentIQ_Subscriber_AutomatedbestwebsiteCommentSubscriber($this->get_bestwebsite_comment_generator(), $this->get_supported_post_types()),
